...
class TCP4_777(BaseTest):
    ...
    def test_tcp4_777(self):
        ...
        pageRequest = PageRequest(self.driver, data)
        ...
        # Assert the saving was succesfull
        pageNewRequest.open_request(process_name)

        # Go to requests page
        self.log.append('Step 9: Opens the request page////////////////')
        pageMenu.goto_request()
        self.log.append('Step 10: Start speciic request////////////////')
        pageRequest.search_request(process_name)
...
if __name__ == "__main__":
    ...
    '''
    output = util.run_test(TCP4_777, data, __main__)
print(output)
